...
export function getAuditActionDescription(action: string) {
  const descriptions: Record<string, string> = {
    "evidence.added":
      "A supporting evidence item was added to this record.",
    "evidence.deleted":
      "A supporting evidence item was removed from this record.",
    "proof_link.generated":
      "A public ProofTrail identity was generated for controlled sharing.",
    "proof_link.deactivated":
      "Public access to this proof identity was withdrawn.",
    "achievement.updated":
      "The record details were updated.",
    "achievement.deleted":
      "The record was permanently removed from the vault.",
    "achievement.created":
      "The record was created inside the vault.",
  };
